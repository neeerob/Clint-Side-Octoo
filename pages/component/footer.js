...
export default function Footer(){
    return(
        <>
            ...
            <footer className="bg-soft-white rounded-lg shadow dark:bg-gray-900 m-4">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <a href="/" className="flex items-center mb-4 sm:mb-0">
                            ...
                            /> */}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 mb-4 text-base font-extrabold leading-none tracking-tight text-gray-900 md:text-1.5xl dark:text-white">Octo <mark className="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Shop</mark></span>
                        </a>
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/neeerob" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 develop by <a href="https://github.com/neeerob" className="text-gray-700 font-bold hover:underline">neeerob</a> 🦌. All Rights Reserved.</span>
                </div>
            </footer>
