  ...
  <div className="bg-soft-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div style={{ marginLeft: '0px' }} class="w-80 bg-white p-6 border-t-4 border-indigo-600">
      ...
      <div class="mt-0 text-center">
            ...
            <span class="hidden text-gray-400 lg:block">Moderator</span>
    </div>
      <ul
      ...
      >
        ...
        <li>
        <a onClick={handelUserClick}  class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
        ...
        <li>
          <a onClick={handelShopClick} class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
        ...
        <li>
          <a onClick={handelProductClick} class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
        ...
        <li>
          <a onClick={handelCouponClick} class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
