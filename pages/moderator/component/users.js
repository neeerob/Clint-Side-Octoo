...
export default function GetAllUsers({ data }) {
  ...
  return (
      ...
      <table class="w-full">
                ...
                >
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                        <p class="whitespace-no-wrap">{product.Firstname} {product.Lastname}</p>
    ...
    <div class="flex flex-col items-center border-t bg-white px-5 py-5 sm:flex-row sm:justify-between">
            <span class="text-xs text-gray-600 sm:text-sm"> Total <span class="text-indigo-500">{count}</span> active user found and <span class="text-red-500">{blockedCount}</span> blocked users. </span>
